class SecretConfig {
  // Network Config
  static const String localSsid = 'VIYA';
  static const String plugIpAddress = '192.168.0.105';
  static const String localHttpPort = '80';
  
  // MQTT Config
  static const String mqttBrokerHost = '192.168.0.99'; // Placeholder, user will change it
