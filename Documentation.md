...
### 4.5 Data Visualizers
* **Daily Energy Chart (`daily_energy_chart.dart`):** A Bar Chart comparing Today, Yesterday, 2 Days Ago, and 3 Days Ago energy consumption.
* **Device Health (`device_health.dart`):** Renders critical diagnostics including MAC Address, IP, Firmware Version, WiFi Signal Strength, and internal Chip Temperature.
